...
<li>Practice 4 : Functional annotation <a target="_blank" href="{{ site.url }}/trinityTrinotate/TP-annotation">see</a> </li>
<li>Differential Expression slides : <a target="_blank" href="{{ site.url }}/files/de_2019.pdf">see</a></li>
<li>Practice 5 : Differential Expression Analysis (DE) <a target="_blank" href="{{ site.url }}/trinityTrinotate/TP-trinity/#practice-4">see</a> </li>
</ul>
</div>
