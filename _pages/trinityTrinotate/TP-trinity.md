...
# and CHECK (not run) the command line found in run_trinity.sh. Trinity is running with trimmomatic and normalisation parametters
...
{% highlight python %}
scp -r  nas:/data2/formation/TP-trinity/TRINITY_OUT/TRINITY_OUT/ /scratch/formationX/
