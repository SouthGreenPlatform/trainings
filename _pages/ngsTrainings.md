...
<tr>
    <td>
        <table class="table-contact"><tr><td><img class="img-logo" src="{{ site.url }}/images/logo/logo_lapse.png" alt="" /></td><td><img class="img-logo"  src="{{ site.url }}/images/logo/logo_iavao.jpeg" alt="" /></td></tr>
        <tr><td><img class="img-logo"  src="{{ site.url }}/images/logo/logo_ceraas.jpeg" alt="" /></td><td><img class="img-logo"   src="{{ site.url }}/images/logo-cirad.png" alt="" /></td></tr>
        <tr><td><img class="img-logo"   src="{{ site.url }}/images/logo_ird.png" alt="" /></td><td><img class="img-logo"   src="{{ site.url }}/images/logo/logo_isra.jpg" alt="" /></td></tr></table>
    </td>
<td>
