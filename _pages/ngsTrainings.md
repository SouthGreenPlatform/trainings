...
<h3>Programme</h3>
<ul>
<li>Introduction à linux et aux lignes de commandes - <a target="_blank" href="{{ site.url }}/files/linux/GuideDeSurvieLinux-french-THIES.pdf">cours</a>, <a target="_blank" href="{{ site.url }}/linux/linuxPractice">exo</a> </li>
