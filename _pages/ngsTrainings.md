...
<tr>
    <td>
        <table class="table-contact"><tr><td><img height="95" src="{{ site.url }}/images/logo/logo_lapse.png" alt="" /></td><td><img height="95"  src="{{ site.url }}/images/logo/logo_iavao.jpeg" alt="" /></td></tr>
        <tr><td><img height="95"  src="{{ site.url }}/images/logo/logo_ceraas.jpeg" alt="" /></td><td><img height="95"   src="{{ site.url }}/images/logo-cirad.png" alt="" /></td></tr>
