...
<li>Présentation des technologies de séquençages - <a target="_blank" href="{{ site.url }}/files/NGS-methode.pdf">NGS</a>, <a target="_blank" href="{{ site.url }}/files/NGS-analyses.pdf">applications</a>,  <a target="_blank" href="{{ site.url }}/files/TPmapping.pdf">exo</a></li>
<li>Linux avancé</li>
